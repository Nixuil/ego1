...
import com.ego.egoGoods.client.BrandClient;
import com.ego.egoGoods.client.CategoryClient;
import com.ego.egoGoods.client.GoodsClient;
...
public class GoodsService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        //查询商品信息
        SpuVo spuBo = this.goodsClient.queryGoodsById(spuId);
        ...
        //查询品牌信息
        Brand brand = this.brandClient.queryBrandListByIds(Collections.singletonList(spuBo.getBrandId())).getBody().get(0);
